...
export class FileSystemPathController {
  ...
  private static async convertPowerPointToPDF(fileContent: Buffer): Promise<Buffer> {
      ...
      if (preview === 'true') {
        try {
          ...
          const styledHtml = `
            <html>
              <head>
                <title>PowerPoint Preview - ${path.basename(filePath as string)}</title>
                <style>
                  body { 
              ...
              <body>
                <div class="preview-container">
                  <div class="preview-content">
                    <h2>📊 PowerPoint Präsentation: ${path.basename(filePath as string)}</h2>
                    ${slidesContent}
                  </div>
                </div>
              </body>
                ...
                <div class="preview-container">
                  <div class="preview-content">
                    <div class="powerpoint-info">
                      ...
                      <p><strong>Datei:</strong> ${path.basename(filePath as string)}</p>
