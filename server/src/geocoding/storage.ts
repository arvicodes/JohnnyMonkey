...
export interface IStorage {
  ...
  getTopicProgress(userId: number, topicId: number, difficulty: string): Promise<TopicProgress | undefined>;
  getUserTopicProgress(userId: number): Promise<TopicProgress[]>;
  createTopicProgress(progress: InsertTopicProgress): Promise<TopicProgress>;
  updateTopicProgress(userId: number, topicId: number, difficulty: string, updates: Partial<TopicProgress>): Promise<TopicProgress | undefined>;
  
  // Game state methods
  getGameState(userId: number): Promise<GameState | undefined>;
  createGameState(gameState: InsertGameState): Promise<GameState>;
  updateGameState(userId: number, gameState: Partial<GameState>): Promise<GameState | undefined>;
  
  // Points of interest methods
  getAllPoints(): Promise<PointOfInterest[]>;
  getPointsByTopicAndDifficulty(topicId: number, difficulty: string): Promise<PointOfInterest[]>;
  ...
  getPuzzleAttempts(userId: number, pointId: number): Promise<PuzzleAttempt[]>;
}
...
export class MemStorage implements IStorage {
  ...
  private puzzleAttempts: Map<number, PuzzleAttempt>;
  ...
  private initializeTopics() {
    const informatikThemen: InsertTopic[] = [
      {
    ...
    informatikThemen.forEach(async (topic) => {
      await this.createTopic(topic);
    });
  }

  private async initializeDefaultPoints() {
    const allPoints: InsertPointOfInterest[] = [];
    ...
    const algorithmEasy = [
      {
        topicId: 1, index: 0, difficulty: "easy", name: "Johanniskirche - Algorithmus-Begriff", description: "Was ist ein Algorithmus?",
        ...generateCoordinates(), puzzleType: "algorithm",
        puzzleData: {
      ...
      {
        topicId: 1, index: 1, difficulty: "easy", name: "Marktplatz - Variablen", description: "Daten speichern",
        ...generateCoordinates(), puzzleType: "variables",
        puzzleData: {
      ...
      {
        topicId: 1, index: 2, difficulty: "easy", name: "Rathaus - Datentypen", description: "Arten von Daten",
        ...generateCoordinates(), puzzleType: "types",
        puzzleData: {
      ...
      {
        topicId: 1, index: 3, difficulty: "easy", name: "Schloss - Schleifen", description: "Code wiederholen",
        ...generateCoordinates(), puzzleType: "loops",
        puzzleData: {
      ...
      {
        topicId: 1, index: 4, difficulty: "easy", name: "Bahnhof - Bedingungen", description: "Entscheidungen treffen",
        ...generateCoordinates(), puzzleType: "conditions",
        puzzleData: {
      ...
      {
        topicId: 1, index: 5, difficulty: "easy", name: "Parkplatz - Funktionen", description: "Code strukturieren",
        ...generateCoordinates(), puzzleType: "functions",
        puzzleData: {
      ...
      {
        topicId: 1, index: 6, difficulty: "easy", name: "Bibliothek - Listen", description: "Mehrere Werte speichern",
        ...generateCoordinates(), puzzleType: "lists",
        puzzleData: {
      ...
      {
        topicId: 1, index: 7, difficulty: "easy", name: "Schule - Ein-/Ausgabe", description: "Mit Benutzern kommunizieren",
        ...generateCoordinates(), puzzleType: "io",
        puzzleData: {
      ...
      {
        topicId: 1, index: 8, difficulty: "easy", name: "Post - Operatoren", description: "Berechnungen durchführen",
        ...generateCoordinates(), puzzleType: "operators",
        puzzleData: {
      ...
      {
        topicId: 1, index: 9, difficulty: "easy", name: "Kirche - Debugging", description: "Fehler finden",
        ...generateCoordinates(), puzzleType: "debugging",
        puzzleData: {
    ...
    const algorithmMedium = [
      {
        topicId: 1, index: 0, difficulty: "medium", name: "Johanniskirche - Rekursion", description: "Selbstaufruf von Funktionen",
        ...generateCoordinates(), puzzleType: "recursion",
        puzzleData: {
      ...
      {
        topicId: 1, index: 1, difficulty: "medium", name: "Marktplatz - Sortieren", description: "Daten ordnen",
        ...generateCoordinates(), puzzleType: "sorting",
        puzzleData: {
      ...
      {
        topicId: 1, index: 2, difficulty: "medium", name: "Rathaus - Komplexität", description: "Effizienz messen",
        ...generateCoordinates(), puzzleType: "complexity",
        puzzleData: {
      ...
      {
        topicId: 1, index: 3, difficulty: "medium", name: "Schloss - Suchverfahren", description: "Daten finden",
        ...generateCoordinates(), puzzleType: "search",
        puzzleData: {
      ...
      {
        topicId: 1, index: 4, difficulty: "medium", name: "Bahnhof - Datenstrukturen", description: "Stapel und Warteschlangen",
        ...generateCoordinates(), puzzleType: "structures",
        puzzleData: {
      ...
      {
        topicId: 1, index: 5, difficulty: "medium", name: "Parkplatz - Hash-Tabellen", description: "Schneller Zugriff",
        ...generateCoordinates(), puzzleType: "hashing",
        puzzleData: {
      ...
      {
        topicId: 1, index: 6, difficulty: "medium", name: "Bibliothek - Graphen", description: "Vernetzte Strukturen",
        ...generateCoordinates(), puzzleType: "graphs",
        puzzleData: {
      ...
      {
        topicId: 1, index: 7, difficulty: "medium", name: "Schule - Divide & Conquer", description: "Teile und herrsche",
        ...generateCoordinates(), puzzleType: "divide",
        puzzleData: {
      ...
      {
        topicId: 1, index: 8, difficulty: "medium", name: "Post - Greedy-Algorithmen", description: "Gierige Strategien",
        ...generateCoordinates(), puzzleType: "greedy",
        puzzleData: {
      ...
      {
        topicId: 1, index: 9, difficulty: "medium", name: "Kirche - Backtracking", description: "Systematisches Probieren",
        ...generateCoordinates(), puzzleType: "backtracking",
        puzzleData: {
    ...
    const algorithmHard = [
      {
        topicId: 1, index: 0, difficulty: "hard", name: "Johanniskirche - NP-Vollständigkeit", description: "Komplexitätstheorie",
        ...generateCoordinates(), puzzleType: "complexity-theory",
        puzzleData: {
      ...
      {
        topicId: 1, index: 1, difficulty: "hard", name: "Marktplatz - Dynamische Programmierung", description: "Optimale Teilstrukturen",
        ...generateCoordinates(), puzzleType: "dynamic",
        puzzleData: {
      ...
      {
        topicId: 1, index: 2, difficulty: "hard", name: "Rathaus - Approximationsalgorithmen", description: "Näherungslösungen",
        ...generateCoordinates(), puzzleType: "approximation",
        puzzleData: {
      ...
      {
        topicId: 1, index: 3, difficulty: "hard", name: "Schloss - Parallele Algorithmen", description: "Mehrkern-Computing",
        ...generateCoordinates(), puzzleType: "parallel",
        puzzleData: {
      ...
      {
        topicId: 1, index: 4, difficulty: "hard", name: "Bahnhof - Machine Learning", description: "Lernende Algorithmen",
        ...generateCoordinates(), puzzleType: "ml",
        puzzleData: {
      ...
      {
        topicId: 1, index: 5, difficulty: "hard", name: "Parkplatz - Quantenalgorithmen", description: "Quantencomputing",
        ...generateCoordinates(), puzzleType: "quantum",
        puzzleData: {
      ...
      {
        topicId: 1, index: 6, difficulty: "hard", name: "Bibliothek - Kryptographie", description: "Sichere Algorithmen",
        ...generateCoordinates(), puzzleType: "crypto",
        puzzleData: {
      ...
      {
        topicId: 1, index: 7, difficulty: "hard", name: "Schule - Genetische Algorithmen", description: "Evolutionäre Optimierung",
        ...generateCoordinates(), puzzleType: "genetic",
        puzzleData: {
      ...
      {
        topicId: 1, index: 8, difficulty: "hard", name: "Post - Distributed Computing", description: "Verteilte Systeme",
        ...generateCoordinates(), puzzleType: "distributed",
        puzzleData: {
      ...
      {
        topicId: 1, index: 9, difficulty: "hard", name: "Kirche - Blockchain", description: "Dezentrale Algorithmen",
        ...generateCoordinates(), puzzleType: "blockchain",
        puzzleData: {
    ...
    const dataStructuresEasy = [
      { topicId: 2, index: 0, difficulty: "easy", name: "Array-Grundlagen", description: "Listen verstehen", ...generateCoordinates(), puzzleType: "array",
        puzzleData: { question: "Wie greift man auf das erste Element eines Arrays zu?", answer: "Index 0", hint1: "Arrays beginnen bei 0", hint2: "arr[?]", points: 15,
      ...
      { topicId: 2, index: 1, difficulty: "easy", name: "Array-Größe", description: "Länge bestimmen", ...generateCoordinates(), puzzleType: "array",
        puzzleData: { question: "Mit welcher Methode bestimmt man die Länge eines Arrays in Python?", answer: "len", hint1: "Kurz für length", hint2: "len(array)", points: 15,
      ...
      { topicId: 2, index: 2, difficulty: "easy", name: "Listen-Methoden", description: "Elemente hinzufügen", ...generateCoordinates(), puzzleType: "list",
        puzzleData: { question: "Welche Methode fügt ein Element am Ende einer Liste hinzu?", answer: "append", hint1: "Anhängen auf Englisch", hint2: "list.append(element)", points: 15,
      ...
      { topicId: 2, index: 3, difficulty: "easy", name: "String-Arrays", description: "Text als Liste", ...generateCoordinates(), puzzleType: "string",
        puzzleData: { question: "Wie greift man auf den ersten Buchstaben eines Strings zu?", answer: "text[0]", hint1: "Strings sind wie Listen von Zeichen", hint2: "Eckige Klammern verwenden", points: 15,
      ...
      { topicId: 2, index: 4, difficulty: "easy", name: "Tupel", description: "Unveränderliche Listen", ...generateCoordinates(), puzzleType: "tuple",
        puzzleData: { question: "Was ist der Hauptunterschied zwischen Listen und Tupeln?", answer: "unveränderlich", hint1: "Tupel können nicht verändert werden", hint2: "Immutable auf Englisch", points: 15,
      ...
      { topicId: 2, index: 5, difficulty: "easy", name: "Dictionaries", description: "Schlüssel-Wert-Paare", ...generateCoordinates(), puzzleType: "dict",
        puzzleData: { question: "Wie greift man auf einen Wert im Dictionary zu?", answer: "dict[key]", hint1: "Über den Schlüssel", hint2: "Eckige Klammern mit Schlüssel", points: 15,
      ...
      { topicId: 2, index: 6, difficulty: "easy", name: "Sets", description: "Eindeutige Elemente", ...generateCoordinates(), puzzleType: "set",
        puzzleData: { question: "Was ist die Besonderheit von Sets?", answer: "keine Duplikate", hint1: "Jedes Element nur einmal", hint2: "Mathematische Menge", points: 15,
      ...
      { topicId: 2, index: 7, difficulty: "easy", name: "List Slicing", description: "Teilbereiche extrahieren", ...generateCoordinates(), puzzleType: "slice",
        puzzleData: { question: "Was gibt list[1:3] zurück?", answer: "Elemente 1 und 2", hint1: "Start inklusive, Ende exklusive", hint2: "Index 1 bis 2", points: 15,
      ...
      { topicId: 2, index: 8, difficulty: "easy", name: "Nested Lists", description: "Listen in Listen", ...generateCoordinates(), puzzleType: "nested",
        puzzleData: { question: "Wie greift man auf ein Element in einer verschachtelten Liste zu?", answer: "liste[i][j]", hint1: "Zwei Indizes verwenden", hint2: "Erst äußere, dann innere Liste", points: 15,
      ...
      { topicId: 2, index: 9, difficulty: "easy", name: "List Comprehensions", description: "Listen elegant erstellen", ...generateCoordinates(), puzzleType: "comprehension",
        puzzleData: { question: "Was erstellt [x*2 for x in range(3)]?", answer: "[0, 2, 4]", hint1: "Jedes x wird verdoppelt", hint2: "x = 0, 1, 2", points: 15,
    ...
    const dataStructuresMedium = [
      { topicId: 2, index: 0, difficulty: "medium", name: "Stack Implementation", description: "LIFO-Prinzip", ...generateCoordinates(), puzzleType: "stack",
        puzzleData: { question: "Welche Operation entfernt das oberste Element vom Stack?", answer: "pop", hint1: "Last In, First Out", hint2: "Gegenteil von push", points: 25,
      ...
      { topicId: 2, index: 1, difficulty: "medium", name: "Queue Implementation", description: "FIFO-Prinzip", ...generateCoordinates(), puzzleType: "queue",
        puzzleData: { question: "Wo wird bei einer Queue ein neues Element hinzugefügt?", answer: "am Ende", hint1: "First In, First Out", hint2: "Wie in einer Warteschlange", points: 25,
      ...
      { topicId: 2, index: 2, difficulty: "medium", name: "Linked Lists", description: "Verkettete Listen", ...generateCoordinates(), puzzleType: "linked",
        puzzleData: { question: "Was speichert jeder Knoten in einer verketteten Liste?", answer: "Daten und Zeiger", hint1: "Wert und Verweis", hint2: "Data und Next", points: 25,
      ...
      { topicId: 2, index: 3, difficulty: "medium", name: "Binary Trees", description: "Binäre Bäume", ...generateCoordinates(), puzzleType: "tree",
        puzzleData: { question: "Wie viele Kinder hat maximal ein Knoten im Binärbaum?", answer: "2", hint1: "Binär bedeutet zwei", hint2: "Links und rechts", points: 25,
      ...
      { topicId: 2, index: 4, difficulty: "medium", name: "Hash Tables", description: "Assoziative Arrays", ...generateCoordinates(), puzzleType: "hash",
        puzzleData: { question: "Was ist das Ziel einer guten Hash-Funktion?", answer: "gleichmäßige Verteilung", hint1: "Kollisionen vermeiden", hint2: "Alle Slots nutzen", points: 25,
      ...
      { topicId: 2, index: 5, difficulty: "medium", name: "Heaps", description: "Prioritätswarteschlangen", ...generateCoordinates(), puzzleType: "heap",
        puzzleData: { question: "Welche Eigenschaft hat ein Min-Heap?", answer: "Eltern kleiner als Kinder", hint1: "Minimum an der Wurzel", hint2: "Kleinste Wert oben", points: 25,
      ...
      { topicId: 2, index: 6, difficulty: "medium", name: "Trie", description: "Präfix-Bäume", ...generateCoordinates(), puzzleType: "trie",
        puzzleData: { question: "Wofür werden Tries hauptsächlich verwendet?", answer: "Wörterbücher", hint1: "Speichern von Strings", hint2: "Autocompletion", points: 25,
      ...
      { topicId: 2, index: 7, difficulty: "medium", name: "Graph Representation", description: "Graphen darstellen", ...generateCoordinates(), puzzleType: "graph",
        puzzleData: { question: "Welche zwei Hauptarten gibt es, Graphen zu speichern?", answer: "Adjazenzmatrix und Adjazenzliste", hint1: "Matrix oder Listen", hint2: "Nachbarschaft darstellen", points: 25,
      ...
      { topicId: 2, index: 8, difficulty: "medium", name: "Deque", description: "Double-ended Queue", ...generateCoordinates(), puzzleType: "deque",
        puzzleData: { question: "Was ist das Besondere an einer Deque?", answer: "Einfügen und Entfernen an beiden Enden", hint1: "Double-ended", hint2: "Vorne und hinten", points: 25,
      ...
      { topicId: 2, index: 9, difficulty: "medium", name: "Disjoint Set", description: "Union-Find", ...generateCoordinates(), puzzleType: "union-find",
        puzzleData: { question: "Was macht die Union-Operation?", answer: "verbindet zwei Mengen", hint1: "Vereinigung von Sets", hint2: "Zusammenführen", points: 25,
    ...
    const dataStructuresHard = [
      { topicId: 2, index: 0, difficulty: "hard", name: "B-Trees", description: "Selbstbalancierende Bäume", ...generateCoordinates(), puzzleType: "btree",
        puzzleData: { question: "Warum werden B-Bäume in Datenbanken verwendet?", answer: "minimieren Festplattenzugriffe", hint1: "Breite statt Tiefe", hint2: "Viele Schlüssel pro Knoten", points: 40,
      ...
      { topicId: 2, index: 1, difficulty: "hard", name: "Red-Black Trees", description: "Rot-Schwarz-Bäume", ...generateCoordinates(), puzzleType: "rb-tree",
        puzzleData: { question: "Welche Eigenschaft garantiert die Balance in Rot-Schwarz-Bäumen?", answer: "schwarze Höhe", hint1: "Jeder Pfad hat gleich viele schwarze Knoten", hint2: "Keine zwei roten Knoten nacheinander", points: 40,
      ...
      { topicId: 2, index: 2, difficulty: "hard", name: "Segment Trees", description: "Bereichsabfragen", ...generateCoordinates(), puzzleType: "segment",
        puzzleData: { question: "Welche Zeitkomplexität haben Bereichsabfragen in Segment Trees?", answer: "O(log n)", hint1: "Logarithmisch", hint2: "Wie bei binären Bäumen", points: 40,
      ...
      { topicId: 2, index: 3, difficulty: "hard", name: "Fenwick Trees", description: "Binary Indexed Trees", ...generateCoordinates(), puzzleType: "fenwick",
        puzzleData: { question: "Was ist der Hauptvorteil von Fenwick Trees gegenüber Segment Trees?", answer: "weniger Speicher", hint1: "Kompaktere Darstellung", hint2: "Nur Array statt Baum", points: 40,
      ...
      { topicId: 2, index: 4, difficulty: "hard", name: "Suffix Arrays", description: "String-Indizierung", ...generateCoordinates(), puzzleType: "suffix",
        puzzleData: { question: "Wie werden Suffix Arrays konstruiert?", answer: "Sortierung aller Suffixe", hint1: "Alle Endungen des Strings", hint2: "Lexikographisch ordnen", points: 40,
      ...
      { topicId: 2, index: 5, difficulty: "hard", name: "Van Emde Boas Trees", description: "Integer-Datenstrukturen", ...generateCoordinates(), puzzleType: "veb",
        puzzleData: { question: "Welche Zeitkomplexität haben Operationen in vEB-Trees?", answer: "O(log log u)", hint1: "Doppelt logarithmisch", hint2: "u ist das Universum", points: 40,
      ...
      { topicId: 2, index: 6, difficulty: "hard", name: "Persistent Data Structures", description: "Unveränderliche Strukturen", ...generateCoordinates(), puzzleType: "persistent",
        puzzleData: { question: "Was ist der Vorteil persistenter Datenstrukturen?", answer: "alle Versionen verfügbar", hint1: "Keine Mutation", hint2: "Strukturelles Teilen", points: 40,
      ...
      { topicId: 2, index: 7, difficulty: "hard", name: "Rope Data Structure", description: "Effiziente Strings", ...generateCoordinates(), puzzleType: "rope",
        puzzleData: { question: "Warum sind Ropes bei sehr langen Strings vorteilhaft?", answer: "effiziente Verkettung", hint1: "Keine Kopien des gesamten Strings", hint2: "Binärer Baum von Strings", points: 40,
      ...
      { topicId: 2, index: 8, difficulty: "hard", name: "Bloom Filters", description: "Probabilistische Datenstrukturen", ...generateCoordinates(), puzzleType: "bloom",
      ...
      { topicId: 2, index: 9, difficulty: "hard", name: "Skip Lists", description: "Probabilistische Balance", ...generateCoordinates(), puzzleType: "skip",
        puzzleData: { question: "Wie erreichen Skip Lists ihre Effizienz?", answer: "multiple Level", hint1: "Verschiedene Ebenen mit unterschiedlicher Dichte", hint2: "Probabilistische Struktur", points: 40,
    ...
    const oopEasy = [
      { topicId: 3, index: 0, difficulty: "easy", name: "Klassen-Konzept", description: "OOP Grundlagen", ...generateCoordinates(), puzzleType: "oop",
        puzzleData: { question: "Was ist eine Klasse?", answer: "Bauplan", hint1: "Vorlage für Objekte", hint2: "Definiert Struktur und Verhalten", points: 15,
      ...
      { topicId: 3, index: 1, difficulty: "easy", name: "Objekterstellung", description: "Instanziierung", ...generateCoordinates(), puzzleType: "object",
        puzzleData: { question: "Wie erstellt man ein Objekt aus einer Klasse?", answer: "Instanziierung", hint1: "Aufruf des Konstruktors", hint2: "new Klassenname() in Java", points: 15,
      ...
      { topicId: 3, index: 2, difficulty: "easy", name: "Attribute", description: "Objekteigenschaften", ...generateCoordinates(), puzzleType: "attributes",
        puzzleData: { question: "Was sind Attribute in der OOP?", answer: "Eigenschaften", hint1: "Daten eines Objekts", hint2: "Variablen in der Klasse", points: 15,
      ...
      { topicId: 3, index: 3, difficulty: "easy", name: "Methoden", description: "Objektverhalten", ...generateCoordinates(), puzzleType: "methods",
        puzzleData: { question: "Was sind Methoden in der OOP?", answer: "Funktionen", hint1: "Verhalten eines Objekts", hint2: "Operationen auf Daten", points: 15,
      ...
      { topicId: 3, index: 4, difficulty: "easy", name: "Konstruktor", description: "Objektinitialisierung", ...generateCoordinates(), puzzleType: "constructor",
        puzzleData: { question: "Was macht ein Konstruktor?", answer: "initialisiert Objekt", hint1: "Wird bei Objekterstellung aufgerufen", hint2: "Setzt Anfangswerte", points: 15,
      ...
      { topicId: 3, index: 5, difficulty: "easy", name: "Kapselung", description: "Datenschutz", ...generateCoordinates(), puzzleType: "encapsulation",
        puzzleData: { question: "Was bedeutet Kapselung in der OOP?", answer: "Daten verstecken", hint1: "Private Attribute und Methoden", hint2: "Zugriff nur über definierte Schnittstellen", points: 15,
      ...
      { topicId: 3, index: 6, difficulty: "easy", name: "Vererbung", description: "Klassen erweitern", ...generateCoordinates(), puzzleType: "inheritance",
        puzzleData: { question: "Was ermöglicht Vererbung?", answer: "Eigenschaften übernehmen", hint1: "Kindklasse von Elternklasse", hint2: "extends in Java", points: 15,
      ...
      { topicId: 3, index: 7, difficulty: "easy", name: "Polymorphismus", description: "Vielgestaltigkeit", ...generateCoordinates(), puzzleType: "polymorphism",
        puzzleData: { question: "Was ist Polymorphismus?", answer: "gleiche Schnittstelle, verschiedenes Verhalten", hint1: "Methodenüberladung und -überschreibung", hint2: "Ein Interface, viele Implementierungen", points: 15,
      ...
      { topicId: 3, index: 8, difficulty: "easy", name: "Abstraktion", description: "Vereinfachung", ...generateCoordinates(), puzzleType: "abstraction",
        puzzleData: { question: "Was ist Abstraktion in der OOP?", answer: "Vereinfachung", hint1: "Weglassen unwichtiger Details", hint2: "Fokus auf das Wesentliche", points: 15,
      ...
      { topicId: 3, index: 9, difficulty: "easy", name: "Interface", description: "Verträge definieren", ...generateCoordinates(), puzzleType: "interface",
        puzzleData: { question: "Was definiert ein Interface?", answer: "Methodensignaturen", hint1: "Vertrag für Implementierung", hint2: "Ohne Implementierung", points: 15,
    ...
    const oopMedium = [
      { topicId: 3, index: 0, difficulty: "medium", name: "Design Patterns", description: "Bewährte Lösungen", ...generateCoordinates(), puzzleType: "patterns",
        puzzleData: { question: "Was ist das Singleton Pattern?", answer: "nur eine Instanz", hint1: "Genau ein Objekt einer Klasse", hint2: "Globaler Zugriffspunkt", points: 25,
      ...
      { topicId: 3, index: 1, difficulty: "medium", name: "Factory Pattern", description: "Objekterstellung", ...generateCoordinates(), puzzleType: "factory",
        puzzleData: { question: "Was macht das Factory Pattern?", answer: "Objekte erstellen", hint1: "Kapselt Objekterstellung", hint2: "Entscheidet welche Klasse instanziiert wird", points: 25,
      ...
      { topicId: 3, index: 2, difficulty: "medium", name: "Observer Pattern", description: "Benachrichtigungen", ...generateCoordinates(), puzzleType: "observer",
        puzzleData: { question: "Wofür wird das Observer Pattern verwendet?", answer: "Benachrichtigungen", hint1: "Ein Objekt informiert viele", hint2: "Lose Kopplung zwischen Objekten", points: 25,
      ...
      { topicId: 3, index: 3, difficulty: "medium", name: "Strategy Pattern", description: "Austauschbare Algorithmen", ...generateCoordinates(), puzzleType: "strategy",
        puzzleData: { question: "Was ermöglicht das Strategy Pattern?", answer: "Algorithmen austauschen", hint1: "Verschiedene Implementierungen zur Laufzeit", hint2: "Kapselt Algorithmen in eigene Klassen", points: 25,
      ...
      { topicId: 3, index: 4, difficulty: "medium", name: "Decorator Pattern", description: "Objekte erweitern", ...generateCoordinates(), puzzleType: "decorator",
        puzzleData: { question: "Was macht das Decorator Pattern?", answer: "Funktionalität hinzufügen", hint1: "Ohne Vererbung erweitern", hint2: "Zur Laufzeit anpassbar", points: 25,
      ...
      { topicId: 3, index: 5, difficulty: "medium", name: "Adapter Pattern", description: "Inkompatible Interfaces", ...generateCoordinates(), puzzleType: "adapter",
        puzzleData: { question: "Wofür wird das Adapter Pattern verwendet?", answer: "Interfaces anpassen", hint1: "Inkompatible Klassen verbinden", hint2: "Wrapper um bestehende Klasse", points: 25,
      ...
      { topicId: 3, index: 6, difficulty: "medium", name: "Command Pattern", description: "Anfragen kapseln", ...generateCoordinates(), puzzleType: "command",
        puzzleData: { question: "Was kapselt das Command Pattern?", answer: "Anfragen", hint1: "Aktionen als Objekte", hint2: "Ermöglicht Undo/Redo", points: 25,
      ...
      { topicId: 3, index: 7, difficulty: "medium", name: "MVC Pattern", description: "Architektur trennen", ...generateCoordinates(), puzzleType: "mvc",
        puzzleData: { question: "Wofür steht MVC?", answer: "Model View Controller", hint1: "Trennt Daten, Darstellung und Logik", hint2: "Architekturmuster", points: 25,
      ...
      { topicId: 3, index: 8, difficulty: "medium", name: "Dependency Injection", description: "Abhängigkeiten verwalten", ...generateCoordinates(), puzzleType: "di",
        puzzleData: { question: "Was ist Dependency Injection?", answer: "Abhängigkeiten von außen", hint1: "Objekte werden injiziert", hint2: "Reduziert Kopplung", points: 25,
      ...
      { topicId: 3, index: 9, difficulty: "medium", name: "SOLID Prinzipien", description: "Design-Grundsätze", ...generateCoordinates(), puzzleType: "solid",
        puzzleData: { question: "Wofür steht das S in SOLID?", answer: "Single Responsibility", hint1: "Eine Klasse, eine Aufgabe", hint2: "Jede Klasse hat nur einen Grund zur Änderung", points: 25,
    ...
    const oopHard = [
      { topicId: 3, index: 0, difficulty: "hard", name: "Metaprogramming", description: "Code über Code", ...generateCoordinates(), puzzleType: "meta",
        puzzleData: { question: "Was ist Metaprogramming?", answer: "Programme schreiben Programme", hint1: "Code zur Laufzeit ändern", hint2: "Reflection und Introspection", points: 40,
      ...
      { topicId: 3, index: 1, difficulty: "hard", name: "Aspect-Oriented Programming", description: "Querschnittsfunktionen", ...generateCoordinates(), puzzleType: "aop",
        puzzleData: { question: "Was löst AOP?", answer: "Cross-cutting Concerns", hint1: "Logging, Security über mehrere Klassen", hint2: "Trennt Geschäftslogik von technischen Aspekten", points: 40,
      ...
      { topicId: 3, index: 2, difficulty: "hard", name: "Domain-Driven Design", description: "Fachlichkeit im Fokus", ...generateCoordinates(), puzzleType: "ddd",
        puzzleData: { question: "Was ist das Herzstück von DDD?", answer: "Domain Model", hint1: "Fachliche Domäne steht im Zentrum", hint2: "Ubiquitous Language", points: 40,
      ...
      { topicId: 3, index: 3, difficulty: "hard", name: "Event Sourcing", description: "Ereignisse speichern", ...generateCoordinates(), puzzleType: "event-sourcing",
        puzzleData: { question: "Was speichert Event Sourcing?", answer: "Ereignisse statt Zustand", hint1: "Komplette Historie verfügbar", hint2: "Zustand durch Replay rekonstruierbar", points: 40,
      ...
      { topicId: 3, index: 4, difficulty: "hard", name: "CQRS", description: "Command Query Separation", ...generateCoordinates(), puzzleType: "cqrs",
        puzzleData: { question: "Was trennt CQRS?", answer: "Lesen und Schreiben", hint1: "Commands ändern Zustand", hint2: "Queries lesen Daten", points: 40,
      ...
      { topicId: 3, index: 5, difficulty: "hard", name: "Microservices", description: "Kleine Services", ...generateCoordinates(), puzzleType: "microservices",
        puzzleData: { question: "Was charakterisiert Microservices?", answer: "kleine, unabhängige Services", hint1: "Single Responsibility auf Service-Ebene", hint2: "Dezentrale Datenhaltung", points: 40,
      ...
      { topicId: 3, index: 6, difficulty: "hard", name: "Reactive Programming", description: "Asynchrone Datenströme", ...generateCoordinates(), puzzleType: "reactive",
        puzzleData: { question: "Was sind Observables in Reactive Programming?", answer: "asynchrone Datenströme", hint1: "Push-basierte Sequenzen", hint2: "Observer Pattern für asynchrone Daten", points: 40,
      ...
      { topicId: 3, index: 7, difficulty: "hard", name: "Functional OOP", description: "Funktional und objektorientiert", ...generateCoordinates(), puzzleType: "functional-oop",
        puzzleData: { question: "Was kombiniert Functional OOP?", answer: "Funktionale und OO Paradigmen", hint1: "Immutable Objects", hint2: "Higher-Order Functions in Objekten", points: 40,
      ...
      { topicId: 3, index: 8, difficulty: "hard", name: "Type Systems", description: "Typsicherheit", ...generateCoordinates(), puzzleType: "types",
        puzzleData: { question: "Was ist der Unterschied zwischen statischer und dynamischer Typisierung?", answer: "Zeitpunkt der Typprüfung", hint1: "Compile-time vs Runtime", hint2: "Java vs Python", points: 40,
      ...
      { topicId: 3, index: 9, difficulty: "hard", name: "Memory Management", description: "Speicherverwaltung", ...generateCoordinates(), puzzleType: "memory",
        puzzleData: { question: "Was ist Garbage Collection?", answer: "automatische Speicherfreigabe", hint1: "Nicht mehr referenzierte Objekte", hint2: "Mark and Sweep Algorithm", points: 40,
    ...
    const technicalEasy = Array.from({length: 10}, (_, i) => ({
      topicId: 4, index: i, difficulty: "easy", name: `Binärtechnik ${i+1}`, description: "Digitale Grundlagen",
      ...generateCoordinates(), puzzleType: "binary",
      puzzleData: { 
    ...
    const technicalMedium = Array.from({length: 10}, (_, i) => ({
      topicId: 4, index: i, difficulty: "medium", name: `Prozessortechnik ${i+1}`, description: "Hardware-Architektur",
      ...generateCoordinates(), puzzleType: "hardware",
      puzzleData: { 
    ...
    const technicalHard = Array.from({length: 10}, (_, i) => ({
      topicId: 4, index: i, difficulty: "hard", name: `Compilerbau ${i+1}`, description: "Übersetzer-Technik",
      ...generateCoordinates(), puzzleType: "compiler",
      puzzleData: { 
    ...
    const databaseEasy = Array.from({length: 10}, (_, i) => ({
      topicId: 5, index: i, difficulty: "easy", name: `SQL Grundlagen ${i+1}`, description: "Datenbankabfragen",
      ...generateCoordinates(), puzzleType: "sql",
      puzzleData: { 
    ...
    const databaseMedium = Array.from({length: 10}, (_, i) => ({
      topicId: 5, index: i, difficulty: "medium", name: `Datenbank-Design ${i+1}`, description: "Normalisierung",
      ...generateCoordinates(), puzzleType: "design",
      puzzleData: { 
    ...
    const databaseHard = Array.from({length: 10}, (_, i) => ({
      topicId: 5, index: i, difficulty: "hard", name: `NoSQL & BigData ${i+1}`, description: "Moderne Datenbanken",
      ...generateCoordinates(), puzzleType: "nosql",
      puzzleData: { 
    ...
    allPoints.push(...algorithmEasy, ...algorithmMedium, ...algorithmHard, 
                  ...dataStructuresEasy, ...dataStructuresMedium, ...dataStructuresHard,
                  ...oopEasy, ...oopMedium, ...oopHard,
                  ...technicalEasy, ...technicalMedium, ...technicalHard,
                  ...databaseEasy, ...databaseMedium, ...databaseHard,
                  ...webEasy, ...webMedium, ...webHard,
                  ...societyEasy, ...societyMedium, ...societyHard);

    // Alle Punkte zur Datenbank hinzufügen
    for (const point of allPoints) {
      await this.createPoint(point);
    }
  }
  ...
  // Topic progress methods
  async getTopicProgress(userId: number, topicId: number, difficulty: string): Promise<TopicProgress | undefined> {
    const key = `${userId}-${topicId}-${difficulty}`;
    return this.topicProgress.get(key);
  }

  async getUserTopicProgress(userId: number): Promise<TopicProgress[]> {
    return Array.from(this.topicProgress.values()).filter(progress => progress.userId === userId);
  }

  async createTopicProgress(insertProgress: InsertTopicProgress): Promise<TopicProgress> {
  ...
  async updateTopicProgress(userId: number, topicId: number, difficulty: string, updates: Partial<TopicProgress>): Promise<TopicProgress | undefined> {
    const key = `${userId}-${topicId}-${difficulty}`;
    const existing = this.topicProgress.get(key);
    if (!existing) return undefined;

    const updated: TopicProgress = { ...existing, ...updates };
  ...
  async createGameState(insertGameState: InsertGameState): Promise<GameState> {
    ...
    const gameState: GameState = { 
      ...
      selectedTopicId: insertGameState.selectedTopicId ?? null,
      selectedDifficulty: insertGameState.selectedDifficulty ?? "easy",
      currentPointIndex: insertGameState.currentPointIndex ?? 0,
      playerPosition: insertGameState.playerPosition ?? null,
      createdAt: now,
      updatedAt: now 
    };
  ...
  async updateGameState(userId: number, updates: Partial<GameState>): Promise<GameState | undefined> {
  ...
  async getPointsByTopicAndDifficulty(topicId: number, difficulty: string): Promise<PointOfInterest[]> {
  ...
  async createPuzzleAttempt(insertAttempt: InsertPuzzleAttempt): Promise<PuzzleAttempt> {
    ...
    const attempt: PuzzleAttempt = { 
      ...
      gaveUp: insertAttempt.gaveUp ?? false,
      completedRetry: insertAttempt.completedRetry ?? false,
      createdAt: new Date() 
    };
  ...
  async getPuzzleAttempts(userId: number, pointId: number): Promise<PuzzleAttempt[]> {
    return Array.from(this.puzzleAttempts.values()).filter(
      (attempt) => attempt.userId === userId && attempt.pointId === pointId,
    );
  }
}
