...
router.get('/pptx-as-pdf', FileSystemPathController.readPptxAsPdf);
...
router.post('/save-from-url', FileSystemPathController.saveFromUrl);
...
router.post('/delete-file', FileSystemPathController.deleteFile);
