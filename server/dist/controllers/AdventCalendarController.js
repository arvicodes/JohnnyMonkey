...
exports.fixThemeYear = exports.createDoorsForYear = exports.createDoor = exports.getDoorResults = exports.submitAnswer = exports.getDoor = exports.getLeaderboard = exports.getDoors = void 0;
...
const getDoors = async (req, res) => {
    var _a, _b, _c;
    try {
        const rawYear = parseInt(req.query.year) || new Date().getFullYear();
        const theme = req.query.theme || req.headers['x-advent-theme'] || '';
        const themes = [
        ...
        if (doors.length === 0) {
            if (themeIndex >= 0) {
                ...
                const latestYear = latestYearWith24
                    ...
                    : (_b = (await prisma.adventCalendarDoor.findFirst({
                        orderBy: { year: 'desc' },
                        select: { year: true }
                    }))) === null || _b === void 0 ? void 0 : _b.year;
        ...
        if (themeIndex >= 0 && doorsWithStatus.length === 24) {
            ...
            if (!needsFix && (themeName === 'Informatik' || themeName === 'Tiere' || themeName === 'Mathe Basics')) {
                ...
                const mapByTheme = (day) => {
                    var _a, _b, _c;
                    if (themeName === 'Informatik')
                        return ((_a = curatedCS[day - 1]) === null || _a === void 0 ? void 0 : _a.question) || null;
                    if (themeName === 'Tiere')
                        return ((_b = curatedAnimals[day - 1]) === null || _b === void 0 ? void 0 : _b.question) || null;
                    if (themeName === 'Mathe Basics')
                        return ((_c = curatedMath[day - 1]) === null || _c === void 0 ? void 0 : _c.question) || null;
                    return null;
                };
            ...
            if (needsFix) {
                ...
                const latestYear = latestYearWith24
                    ? latestYearWith24.year
                    : (_c = (await prisma.adventCalendarDoor.findFirst({ orderBy: { year: 'desc' }, select: { year: true } }))) === null || _c === void 0 ? void 0 : _c.year;
                const base = latestYear
                ...
                if (base.length === 24) {
                    ...
                    await prisma.$transaction(base.map((d) => {
                        const themed = buildThemedDoor(d.day);
...
const getLeaderboard = async (req, res) => {
    ...
    try {
        ...
        for (const s of submissions) {
            ...
            if (!studentIdToStats[key]) {
                studentIdToStats[key] = {
                    ...
                    avatarEmoji: ((_b = s.student) === null || _b === void 0 ? void 0 : _b.avatarEmoji) || null,
                    totalSubmissions: 0,
        ...
        const me = (_c = req.user) === null || _c === void 0 ? void 0 : _c.id;
        ...
        if (me && !entries.find(e => e.studentId === me)) {
            entries.unshift({
                studentId: me,
                studentName: ((_d = req.user) === null || _d === void 0 ? void 0 : _d.name) || 'Du',
                avatarEmoji: '🎓',
                totalSubmissions: 0,
                correctSubmissions: 0,
                lastSubmissionAt: undefined
...
const getDoor = async (req, res) => {
    ...
    try {
        ...
        if (themeSuffix >= 1 && themeSuffix <= 10) {
            ...
            const expectedQ = (_b = shortQuestions[themeName]) === null || _b === void 0 ? void 0 : _b[door.day - 1];
...
const fixThemeYear = async (req, res) => {
    var _a;
    try {
        const rawYear = parseInt(req.body.year) || new Date().getFullYear();
        ...
        const latestYear = latestYearWith24
            ? latestYearWith24.year
            : (_a = (await prisma.adventCalendarDoor.findFirst({
                orderBy: { year: 'desc' },
                select: { year: true }
            }))) === null || _a === void 0 ? void 0 : _a.year;
        const base = latestYear
            ? await prisma.adventCalendarDoor.findMany({
                where: { year: latestYear },
                orderBy: { day: 'asc' }
        ...
        res.status(500).json({ error: 'Interner Serverfehler', message: (error === null || error === void 0 ? void 0 : error.message) || 'Unbekannter Fehler' });
    }
};
exports.fixThemeYear = fixThemeYear;
