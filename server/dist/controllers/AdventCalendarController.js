...
exports.createDoorsForYear = exports.createDoor = exports.getDoorResults = exports.submitAnswer = exports.getDoor = exports.getLeaderboard = exports.getDoors = void 0;
...
const getDoors = async (req, res) => {
    ...
    try {
        ...
        const themeIndex = theme ? Math.max(0, themes.indexOf(theme)) : -1;
        ...
        if (doors.length === 0) {
            if (themeIndex >= 0) {
                const base = await prisma.adventCalendarDoor.findMany({
                    orderBy: [{ year: 'desc' }, { day: 'asc' }],
                    take: 24
                });
                if (base.length === 24) {
                    console.log('Erzeuge thematische Türchen für', theme, 'in Jahr', year);
