...
class FileSystemPathController {
    ...
    static savePath(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const savedPath = yield prisma.fileSystemPath.upsert({
    ...
    static getPathsByTeacher(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const { teacherId } = req.params;
                console.log('Getting paths for teacher:', teacherId);
                const paths = yield prisma.fileSystemPath.findMany({
                    where: { teacherId },
    ...
    static readDirectory(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const readDirectoryRecursive = (dirPath, maxDepth = 10, currentDepth = 0) => {
    ...
    static readPowerPointFile(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            var _a;
            try {
                const { filePath, preview } = req.query;
                    ...
                    try {
                        ...
                        if (fileExtension === '.pptx') {
                            ...
                            try {
                                ...
                                const slideCount = ((_a = bufferString.match(/<p:sld[^>]*>/g)) === null || _a === void 0 ? void 0 : _a.length) || 0;
    ...
    static readGoodNotesFile(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const { filePath, preview } = req.query;
    ...
    static deletePath(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const deletedPath = yield prisma.fileSystemPath.delete({
                    where: { id }
                });
        ...
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                if (preview === 'true') {
                    ...
                    try {
                        const result = yield mammoth_1.default.convertToHtml({ buffer: docxBuffer });
