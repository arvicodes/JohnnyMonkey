...
export declare const getDoors: (req: Request, res: Response) => Promise<Response<any, Record<string, any>>>;
...
export declare const fixThemeYear: (req: Request, res: Response) => Promise<Response<any, Record<string, any>>>;
